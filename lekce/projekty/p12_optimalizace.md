# Projekt 12: Optimalizace — najdi a oprav bottleneck

Mini-projekt po **sekci XII (Specializace)**. Porovnání pomalé vs. rychlé implementace počítání slov s `cProfile`.

**Použité koncepty:** `cProfile` (93), `pstats` (93), `timeit` (93), `Counter` (17), optimalizační triky (94).

## Jak spustit

```bash
python3 projekty/12_optimalizace/optimalizuj.py
```

## Zdrojový kód — `optimalizuj.py`
