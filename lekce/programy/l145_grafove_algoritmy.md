# Program — Lekce 145: Lekce 145: Grafové algoritmy

Patří k lekci [Lekce 145: Grafové algoritmy](../145_grafove_algoritmy.md).

## Jak spustit

```bash
python3 programy/l145_grafove_algoritmy.py
```

## Zdrojový kód

### `l145_grafove_algoritmy.py`
