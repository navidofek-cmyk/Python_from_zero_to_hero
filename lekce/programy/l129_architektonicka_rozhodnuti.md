# Program — Lekce 129: Lekce 129 — Architektonická Rozhodnutí a Komunikace

Patří k lekci [Lekce 129 — Architektonická Rozhodnutí a Komunikace](../129_architektonicka_rozhodnuti.md).

## Jak spustit

```bash
python3 programy/l129_architektonicka_rozhodnuti.py
```

## Zdrojový kód

### `l129_architektonicka_rozhodnuti.py`
