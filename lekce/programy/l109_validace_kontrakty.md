# Program — Lekce 109: Lekce 109: Validace a kontrakty — Pydantic v2

Patří k lekci [Lekce 109: Validace a kontrakty — Pydantic v2](../109_validace_kontrakty.md).

## Jak spustit

```bash
python3 programy/l109_validace_kontrakty.py
```

## Zdrojový kód

### `l109_validace_kontrakty.py`
