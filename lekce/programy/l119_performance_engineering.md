# Program — Lekce 119: Lekce 119: Performance Engineering

Patří k lekci [Lekce 119: Performance Engineering](../119_performance_engineering.md).

## Jak spustit

```bash
python3 programy/l119_performance_engineering.py
```

## Zdrojový kód

### `l119_performance_engineering.py`
