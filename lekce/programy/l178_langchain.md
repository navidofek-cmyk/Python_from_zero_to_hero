# Program — Lekce 178: Lekce 178: LangChain — LLM aplikační framework

Patří k lekci [Lekce 178: LangChain — LLM aplikační framework](../178_langchain.md).

## Jak spustit

```bash
python3 programy/l178_langchain.py
```
