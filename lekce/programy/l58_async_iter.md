# Program — Lekce 58: Lekce 58: Async iterátory a generátory

Patří k lekci [Lekce 58: Async iterátory a generátory](../58_async_iteratory.md).

## Jak spustit

```bash
python3 programy/l58_async_iter.py
```
