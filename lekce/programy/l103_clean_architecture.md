# Program — Lekce 103: Lekce 103: Hexagonal / Ports & Adapters / Clean Architecture

Patří k lekci [Lekce 103: Hexagonal / Ports & Adapters / Clean Architecture](../103_clean_architecture.md).

## Jak spustit

```bash
python3 programy/l103_clean_architecture.py
```

## Zdrojový kód

### `l103_clean_architecture.py`
