# Program — Lekce 163: Lekce 163: WebSockets — real-time komunikace

Patří k lekci [Lekce 163: WebSockets — real-time komunikace](../163_websockets.md).

## Jak spustit

```bash
python3 programy/l163_websockets.py
```
