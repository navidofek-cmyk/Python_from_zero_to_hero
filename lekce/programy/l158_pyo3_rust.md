# Program — Lekce 158: Lekce 158: PyO3 — Rust rozšíření pro Python

Patří k lekci [Lekce 158: PyO3 — Rust rozšíření pro Python](../158_pyo3_rust.md).

## Jak spustit

```bash
python3 programy/l158_pyo3_rust.py
```
