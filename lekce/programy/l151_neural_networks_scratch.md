# Program — Lekce 151: Lekce 151: Neuronové sítě od nuly

Patří k lekci [Lekce 151: Neuronové sítě od nuly](../151_neural_networks_scratch.md).

## Jak spustit

```bash
python3 programy/l151_neural_networks_scratch.py
```

## Zdrojový kód

### `l151_neural_networks_scratch.py`
