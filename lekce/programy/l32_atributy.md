# Program — Lekce 32: Lekce 32: Atributy instance vs třídy

Patří k lekci [Lekce 32: Atributy instance vs třídy](../32_atributy_class_instance.md).

## Jak spustit

```bash
python3 programy/l32_atributy.py
```
