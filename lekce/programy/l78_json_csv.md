# Program — Lekce 78: Lekce 78: `json`, `csv`, `tomllib`, `configparser`, `pickle`

Patří k lekci [Lekce 78: `json`, `csv`, `tomllib`, `configparser`, `pickle`](../78_json_csv.md).

## Jak spustit

```bash
python3 programy/l78_json_csv.py
```
