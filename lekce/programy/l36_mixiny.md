# Program — Lekce 36: Lekce 36: Vícenásobná dědičnost a mixiny

Patří k lekci [Lekce 36: Vícenásobná dědičnost a mixiny](../36_vicenasobna_dedicnost.md).

## Jak spustit

```bash
python3 programy/l36_mixiny.py
```
