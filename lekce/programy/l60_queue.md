# Program — Lekce 60: Lekce 60: Streamy a fronty v `asyncio`

Patří k lekci [Lekce 60: Streamy a fronty v `asyncio`](../60_streamy_fronty.md).

## Jak spustit

```bash
python3 programy/l60_queue.py
```
