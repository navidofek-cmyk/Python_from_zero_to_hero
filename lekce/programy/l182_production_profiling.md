# Program — Lekce 182: Lekce 182: Produkční profiling — py-spy a memray

Patří k lekci [Lekce 182: Produkční profiling — py-spy a memray](../182_production_profiling.md).

## Jak spustit

```bash
python3 programy/l182_production_profiling.py
```

## Zdrojový kód

### `l182_production_profiling.py`
