# Program — Lekce 149: Lekce 149: Backtracking — rekurzivní prohledávání

Patří k lekci [Lekce 149: Backtracking — rekurzivní prohledávání](../149_backtracking.md).

## Jak spustit

```bash
python3 programy/l149_backtracking.py
```

## Zdrojový kód

### `l149_backtracking.py`
