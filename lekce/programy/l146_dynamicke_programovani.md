# Program — Lekce 146: Lekce 146: Dynamické programování

Patří k lekci [Lekce 146: Dynamické programování](../146_dynamicke_programovani.md).

## Jak spustit

```bash
python3 programy/l146_dynamicke_programovani.py
```

## Zdrojový kód

### `l146_dynamicke_programovani.py`
