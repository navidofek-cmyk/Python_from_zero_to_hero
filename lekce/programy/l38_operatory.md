# Program — Lekce 38: Lekce 38: Operátorové přetížení

Patří k lekci [Lekce 38: Operátorové přetížení](../38_operatorove_pretizeni.md).

## Jak spustit

```bash
python3 programy/l38_operatory.py
```
