# Program — Lekce 106: Lekce 106: API Design — REST, versioning, BFF, Pydantic

Patří k lekci [Lekce 106: API Design — REST, versioning, BFF, Pydantic](../106_api_design.md).

## Jak spustit

```bash
python3 programy/l106_api_design.py
```
