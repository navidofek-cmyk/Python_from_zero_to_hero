# Program — Lekce 70: Lekce 70: Struktura projektu, `pyproject.toml`

Patří k lekci [Lekce 70: Struktura projektu, `pyproject.toml`](../70_struktura_projektu.md).

## Jak spustit

```bash
python3 programy/l70_struktura_projektu.py
```

## Zdrojový kód

### `l70_struktura_projektu.py`
