# Program — Lekce 148: Lekce 148: Evoluční algoritmy

Patří k lekci [Lekce 148: Evoluční algoritmy](../148_evolucni_algoritmy.md).

## Jak spustit

```bash
python3 programy/l148_evolucni_algoritmy.py
```

## Zdrojový kód

### `l148_evolucni_algoritmy.py`
