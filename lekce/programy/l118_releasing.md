# Program — Lekce 118: Lekce 118 — Releasing, Rollback a Databázové migrace

Patří k lekci [Lekce 118 — Releasing, Rollback a Databázové migrace](../118_releasing.md).

## Jak spustit

```bash
python3 programy/l118_releasing.py
```
