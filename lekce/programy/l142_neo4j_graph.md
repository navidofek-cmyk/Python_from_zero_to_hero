# Program — Lekce 142: Lekce 142: Neo4j — grafová databáze

Patří k lekci [Lekce 142: Neo4j — grafová databáze](../142_neo4j_graph.md).

## Jak spustit

```bash
python3 programy/l142_neo4j_graph.py
```
