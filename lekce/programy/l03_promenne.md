# Program — Lekce 3: Lekce 3: Proměnné, jména a dynamické typování

Patří k lekci [Lekce 3: Proměnné, jména a dynamické typování](../03_promenne_typovani.md).

## Jak spustit

```bash
python3 programy/l03_promenne.py
```
