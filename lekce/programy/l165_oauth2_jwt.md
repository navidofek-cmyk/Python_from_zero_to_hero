# Program — Lekce 165: Lekce 165: OAuth2 a JWT — autentizace API

Patří k lekci [Lekce 165: OAuth2 a JWT — autentizace API](../165_oauth2_jwt.md).

## Jak spustit

```bash
python3 programy/l165_oauth2_jwt.py
```
