# Program — Lekce 128: Lekce 128 — Embeddable Python a Plugin Systémy

Patří k lekci [Lekce 128 — Embeddable Python a Plugin Systémy](../128_embeddable_python.md).

## Jak spustit

```bash
python3 programy/l128_embeddable_python.py
```

## Zdrojový kód

### `l128_embeddable_python.py`
