# Program — Lekce 131: Lekce 131: RAG — Retrieval-Augmented Generation

Patří k lekci [Lekce 131: RAG — Retrieval-Augmented Generation](../131_rag.md).

## Jak spustit

```bash
python3 programy/l131_rag.py
```
