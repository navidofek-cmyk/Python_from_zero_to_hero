# Program — Lekce 17: Lekce 17: `collections` — speciální struktury

Patří k lekci [Lekce 17: `collections` — speciální struktury](../17_collections.md).

## Jak spustit

```bash
python3 programy/l17_collections.py
```
