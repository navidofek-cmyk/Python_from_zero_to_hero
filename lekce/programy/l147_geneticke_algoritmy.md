# Program — Lekce 147: Lekce 147: Genetické algoritmy

Patří k lekci [Lekce 147: Genetické algoritmy](../147_geneticke_algoritmy.md).

## Jak spustit

```bash
python3 programy/l147_geneticke_algoritmy.py
```

## Zdrojový kód

### `l147_geneticke_algoritmy.py`
