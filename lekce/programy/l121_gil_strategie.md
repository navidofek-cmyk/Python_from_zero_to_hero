# Program — Lekce 121: Lekce 121: GIL — strategie v praxi

Patří k lekci [Lekce 121: GIL — strategie v praxi](../121_gil_strategie.md).

## Jak spustit

```bash
python3 programy/l121_gil_strategie.py
```

## Zdrojový kód

### `l121_gil_strategie.py`
