# Program — Lekce 105: Lekce 105: CQRS a Event Sourcing

Patří k lekci [Lekce 105: CQRS a Event Sourcing](../105_cqrs_event_sourcing.md).

## Jak spustit

```bash
python3 programy/l105_cqrs_event_sourcing.py
```

## Zdrojový kód

### `l105_cqrs_event_sourcing.py`
