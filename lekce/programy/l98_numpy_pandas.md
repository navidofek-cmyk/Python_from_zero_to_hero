# Program — Lekce 98: Lekce 98: Datové analýzy — NumPy a pandas

Patří k lekci [Lekce 98: Datové analýzy — NumPy a pandas](../98_data_numpy_pandas.md).

## Jak spustit

```bash
python3 programy/l98_numpy_pandas.py
```
