# Program — Lekce 183: Lekce 183: Python bytecode a CPython internals (deep dive)

Patří k lekci [Lekce 183: Python bytecode a CPython internals (deep dive)](../183_python_bytecode.md).

## Jak spustit

```bash
python3 programy/l183_python_bytecode.py
```

## Zdrojový kód

### `l183_python_bytecode.py`
