# Program — Lekce 72: Lekce 72: Entry points a CLI skripty

Patří k lekci [Lekce 72: Entry points a CLI skripty](../72_entry_points.md).

## Jak spustit

```bash
python3 programy/l72_entry_points.py
```
