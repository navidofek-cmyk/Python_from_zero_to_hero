# Program — Lekce 150: Lekce 150: Divide & Conquer + rekurzivní fraktály

Patří k lekci [Lekce 150: Divide & Conquer + rekurzivní fraktály](../150_divide_and_conquer.md).

## Jak spustit

```bash
python3 programy/l150_divide_and_conquer.py
```

## Zdrojový kód

### `l150_divide_and_conquer.py`
