# Program — Lekce 123: Lekce 123: Distribuované systémy

Patří k lekci [Lekce 123: Distribuované systémy](../123_distribuovane_systemy.md).

## Jak spustit

```bash
python3 programy/l123_distribuovane_systemy.py
```

## Zdrojový kód

### `l123_distribuovane_systemy.py`
