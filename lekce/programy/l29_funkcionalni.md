# Program — Lekce 29: Lekce 29: Funkcionální nástroje — `map`, `filter`, generátory

Patří k lekci [Lekce 29: Funkcionální nástroje — `map`, `filter`, generátory](../29_funkcionalni.md).

## Jak spustit

```bash
python3 programy/l29_funkcionalni.py
```
