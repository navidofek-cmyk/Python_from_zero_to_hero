# Program — Lekce 27: Lekce 27: `functools` — kouzla nad funkcemi

Patří k lekci [Lekce 27: `functools` — kouzla nad funkcemi](../27_functools.md).

## Jak spustit

```bash
python3 programy/l27_functools.py
```
