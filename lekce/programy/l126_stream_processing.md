# Program — Lekce 126: Lekce 126 — Stream Processing

Patří k lekci [Lekce 126 — Stream Processing](../126_stream_processing.md).

## Jak spustit

```bash
python3 programy/l126_stream_processing.py
```

## Zdrojový kód

### `l126_stream_processing.py`
