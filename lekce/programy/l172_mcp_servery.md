# Program — Lekce 172: Lekce 172: MCP Servery — Model Context Protocol

Patří k lekci [Lekce 172: MCP Servery — Model Context Protocol](../172_mcp_servery.md).

## Jak spustit

```bash
python3 programy/l172_mcp_servery.py
```
