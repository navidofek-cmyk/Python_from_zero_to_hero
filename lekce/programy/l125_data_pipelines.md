# Program — Lekce 125: Lekce 125 — Data Engineering Pipelines

Patří k lekci [Lekce 125 — Data Engineering Pipelines](../125_data_pipelines.md).

## Jak spustit

```bash
python3 programy/l125_data_pipelines.py
```

## Zdrojový kód

### `l125_data_pipelines.py`
