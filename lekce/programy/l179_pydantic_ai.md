# Program — Lekce 179: Lekce 179: Pydantic AI — agentní framework

Patří k lekci [Lekce 179: Pydantic AI — agentní framework](../179_pydantic_ai.md).

## Jak spustit

```bash
python3 programy/l179_pydantic_ai.py
```
