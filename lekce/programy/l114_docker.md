# Program — Lekce 114: Lekce 114 — Containerizace Python aplikací

Patří k lekci [Lekce 114 — Containerizace Python aplikací](../114_docker.md).

## Jak spustit

```bash
python3 programy/l114_docker.py
```
