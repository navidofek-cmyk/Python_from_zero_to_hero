# Program — Lekce 120: Lekce 120: Memory Engineering

Patří k lekci [Lekce 120: Memory Engineering](../120_memory_engineering.md).

## Jak spustit

```bash
python3 programy/l120_memory_engineering.py
```

## Zdrojový kód

### `l120_memory_engineering.py`
