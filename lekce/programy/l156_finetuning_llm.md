# Program — Lekce 156: Lekce 156: Fine-tuning LLM — LoRA a PEFT

Patří k lekci [Lekce 156: Fine-tuning LLM — LoRA a PEFT](../156_finetuning_llm.md).

## Jak spustit

```bash
python3 programy/l156_finetuning_llm.py
```

## Zdrojový kód

### `l156_finetuning_llm.py`
