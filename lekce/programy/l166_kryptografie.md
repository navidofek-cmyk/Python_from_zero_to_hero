# Program — Lekce 166: Lekce 166: Kryptografie

Patří k lekci [Lekce 166: Kryptografie](../166_kryptografie.md).

## Jak spustit

```bash
python3 programy/l166_kryptografie.py
```

## Zdrojový kód

### `l166_kryptografie.py`
